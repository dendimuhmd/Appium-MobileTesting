...
public class Smarco {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		desiredCapabilities.setCapability(AndroidMobileCapabilityType.APP_PACKAGE, "id.co.sprout.smarcoappdev");
		desiredCapabilities.setCapability(AndroidMobileCapabilityType.APP_ACTIVITY,
				"id.co.sprout.smarcoappdev.MainActivity");
...
//		driver.findElement(By.xpath("//android.widget.EditText[@text='Nama']")).sendKeys("Muhammad");
//		driver.findElement(By.xpath("//android.widget.EditText[@text='Telepon']")).sendKeys("082182387473");
